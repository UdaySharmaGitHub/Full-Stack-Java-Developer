...
<head>
<meta charset="UTF-8">
<title>View Progress Sales</title>
...
<section>
   <div class="px-4 py-2 my-0 text-center">
    <h1 class="display-5 fw-bold">View And Modify PORGRESS SALES</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-1">Quickly design and customize responsive mobile-first sites with Bootstrap, the world’s most popular front-end open source toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful JavaScript plugins.</p>
          <a href="Progresssales.jsp" class="btn btn-primary">Add New Progress Sales</a>
    </div>
  </div>
  </section>
   <!-- table -->
  ...
  <tbody>
    <%
     ...
     try {
      ...
      <a href='update_progress.jsp?u=<%=resultSet.getString("progressid")%>' class="btn btn-success"><b>Edit</b></a></div></td>
  
       <td><b><form action='DeleteProgress?d=<%=resultSet.getString("progressid")%>' method="post">
       <div class="card" style="width: 5rem;">
         <input type="submit" name="delete" value="Delete" id="<%=resultSet.getString("progressid") %>" class="form-control btn-danger font-weight-bolder">
       </div>
       </form></b></td>
       </tr>
   <% }}catch(Exception e){
