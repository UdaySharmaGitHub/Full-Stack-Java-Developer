...
<head>
<meta charset="UTF-8">
<title>View Complete Sales</title>
...
<img alt="image" src="images/analytics.gif" class="image1"><img alt="image" class="image2" src="images/company-logo.png">
 ...
 <section>
   <div class="px-4 py-2 my-0 text-center">
    <h1 class="display-5 fw-bold">View And Modify SALES</h1>
 ...
 <thead>
  ...
  <tbody>
     ...
     try {
		...
		<tr align="center">
		    <th scope="row"><%out.println(resultSet.getString("leadid")); %></th>
		    <td><b><%out.println(resultSet.getString("leadname")); %></b></td>
		    <td><b><%out.println(resultSet.getString("leadcontact")); %></b></td>
		    <td><b><%out.println(resultSet.getString("salesstatus")); %></b></td>
        
        <td><div class="card" style="width:5rem;">
      <a href='update_sales.jsp?u=<%=resultSet.getString("leadid")%>' class="btn btn-success"><b>Edit</b></a></div></td>
  
       <td><b><form action='DeleteSales?d=<%=resultSet.getString("leadid")%>' method="post">
       <div class="card" style="width: 5rem;">
         <input type="submit" name="delete" value="Delete" id="<%=resultSet.getString("leadid") %>" class="form-control btn-danger font-weight-bolder">
       </div>
       </form></b></td>
       </tr>
