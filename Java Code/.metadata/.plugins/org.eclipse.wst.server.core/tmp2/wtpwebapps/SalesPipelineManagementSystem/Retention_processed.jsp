...
<section>
   <div class="px-4 py-2 my-0 text-center">
    <h1 class="display-5 fw-bold">RETENTION PORCESSED SALES</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-1">Quickly design and customize responsive mobile-first sites with Bootstrap, the world’s most popular front-end open source toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful JavaScript plugins.</p>
          <a href="view-processed.jsp" class="btn btn-primary">Edit Retention Sales</a>
    </div>
  </div>
  </section>
   <!-- table -->
     ...
     try {
         ...
         String usernamedb="root";
      	String passworddb="uday123";
			...
			String selectsql="select * from processed where processedstatus='Retention';";
      ...
      <td><b><form action="Retentiontodisqualified" method="post">
       <div class="card" style="width: 5rem;">
           
                               <input type="hidden" name="Processedid" class="form-control form-control-lg bg-light fs-6" placeholder="Sales Lead Name" required="required" value="<%out.println(resultSet.getString("processedid")); %>">  
                               <input type="hidden" name="Processedstatus" class="form-control form-control-lg bg-light fs-6" placeholder="Sales Lead Name" required="required" value="<%out.println(resultSet.getString("processedstatus")); %>">                              
         <input type="submit" name="retentiontodisqualified" value="Pass" class="form-control btn-success font-weight-bolder">
       </div>
       </form></b></td>
      <!--  -->	    
