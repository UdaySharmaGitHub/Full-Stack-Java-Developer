...
<section>
   <div class="px-4 py-2 my-0 text-center">
    <h1 class="display-5 fw-bold">CLOSING PORCESSED SALES</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-1">Quickly design and customize responsive mobile-first sites with Bootstrap, the world’s most popular front-end open source toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful JavaScript plugins.</p>
          <a href="view-processed.jsp" class="btn btn-primary">Edit Closing Sales</a>
    </div>
  </div>
  </section>
   <!-- table -->
     ...
     try {
         ...
         String usernamedb="root";
      	String passworddb="uday123";
			...
			String selectsql="select * from processed where processedstatus='Closing';";
      ...
      <td><b><form action="Closingtoretention" method="post">
       <div class="card" style="width: 5rem;">
         ...
         <input type="submit" name="closingtoretention" value="Pass" class="form-control btn-success font-weight-bolder">
       </div>
       </form></b></td>
      <!--  -->
