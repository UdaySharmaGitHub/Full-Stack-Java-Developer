...
<img alt="image" src="images/analytics.gif" class="image1"><img alt="image" class="image2" src="images/company-logo.png">
 ...
 <section>
   <div class="px-4 py-2 my-0 text-center">
    <h1 class="display-5 fw-bold">UPDATE  YOUR  SALES</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-1">Quickly design and customize responsive mobile-first sites with Bootstrap, the world’s most popular front-end open source toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful JavaScript plugins.</p>
          <a href="Allsales.jsp" class="btn btn-primary">Add New Sales</a>
    </div>
  </div>
  </section>
<!-- Section-1 -->
 ...
 <%
  ...
  Integer Leadid=Integer.parseInt(u);
  ...
  String usernamedb="root";
	String passworddb="uday123";
		...
		String selectbyidsql="select * from sales where leadid='"+Leadid+"';";
 ...
 <%
   ...
   %>             <div class="input-group mb-2">
                    <input type="hidden" name="Leadid" class="form-control form-control-lg bg-light fs-6" placeholder="Sales Lead id" required="required" value="<%out.println(resultSet.getString("leadid")); %>">
                </div>  
                <div class="input-group mb-2">
                    <input type="text" name="Leadname" class="form-control form-control-lg bg-light fs-6" placeholder="Sales Lead Name" required="required" value="<%out.println(resultSet.getString("leadname")); %>">
                </div>
                <div class="input-group mb-2">
                    <input type="text" name="Leadcontact" class="form-control form-control-lg bg-light fs-6" placeholder="Sales Lead Contact" required="required" value="<%out.println(resultSet.getString("leadcontact")); %>">
                </div>
                <div class="input-group mb-2">
                    <input type="text" name="Salesstatus" class="form-control form-control-lg bg-light fs-6" placeholder="Sales Status " required="required" value="<%out.println(resultSet.getString("salesstatus")); %>">
                </div>
  <%
  }
  %>
                ...
                <div class="input-group mb-3">
                        <input class="btn btn-success w-100 fs-6 py-2" type="submit" value="Update Sale">
                </div>
              </form>
       </div>
       </div>
